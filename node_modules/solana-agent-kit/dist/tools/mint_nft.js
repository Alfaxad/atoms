...
exports.mintCollectionNFT = void 0;
...
async function mintCollectionNFT(agent, collectionMint, metadata, recipient) {
    try {
        ...
        const umi = (0, umi_bundle_defaults_1.createUmi)(agent.connection);
        ...
        await (0, mpl_core_1.create)(umi, {
            ...
            name: metadata.name,
            uri: metadata.uri,
            owner: (0, umi_web3js_adapters_1.fromWeb3JsPublicKey)(recipient)
        }).sendAndConfirm(umi);
        return {
